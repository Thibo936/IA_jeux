...
public class TC_MG_montecarlo extends AI {

    public static final int EMPTY = 0;
    public static final int BLACK = 1;
    public static final int WHITE = 2;
    //public final static String local_player_str = "/Users/n/LudiiPlayers/rand_player";
    public static final String local_player_str = "../TC_MG_montecarlo";

    protected int player = -1; // player_index

    public TC_MG_montecarlo() {
        this.friendlyName = "TC_MG_montecarlo";
    }
    ...
    public Move selectAction(
        ...
        for (final ContainerState containerState : context
            .state()
            .containerStates()) {
            for (int i = 0; i < 64; i++) {
        ...
        try {
            ...
            Process process = startProcessLocal(
                local_player_str,
                sb.toString(),
                turn
            );
        ...
        if (line_i != -1 && col_i != -1 && line_f != -1 && col_f != -1) {
            ...
            for (int i = 0; i < legalMoves.size(); i++) {
                if (
                    legalMoves.get(i).from() == pos_i &&
                    legalMoves.get(i).to() == pos_f
                ) {
    ...
    public Process startProcessLocal(
        String _player_str,
        String _b,
        String _turn
    ) throws IOException {
    ...
    public String endProcessLocal(Process process)
